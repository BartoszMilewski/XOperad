...
-- The comlete simplified version of XOperad with less type magic

module XOperadLite where
...
-- This is the main entry for testing the light version of the operad
test :: IO ()
test = do
